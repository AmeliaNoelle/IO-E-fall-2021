...
/*
This sketch creates a rectangle based on the users nose position.
...
to the moving rectangle.
When the user moves their head the rectangle changes size based on 
their nose x position
*/
...
function draw() {
  ...
  if (poses.length > 0) {
    ...
    fill(nose.x, 0, nose.y);
    //rotate(map(wrist.x, 0, 1920, 0, 360));
    rect(nose.x, nose.y, nose.x/3, nose.x/3);
